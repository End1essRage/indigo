...
type Storage interface {
	//0 count - all
	//TODO query
	Get(ctx context.Context, collection string, count int, query string) ([]Entity, error)
	...
	Update(ctx context.Context, collection string, query string, entity Entity) (int, error)
